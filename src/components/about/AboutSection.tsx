      ...
      <Grid size={{ xs: 12, lg: 7 }}>
        <Stack spacing={5}>
          ...
          <Typography color='text.primary' fontSize={18}>
            ...
            del ecosistema web, desarrollando interfaces limpias y soluciones full stack orientadas
            a la experiencia del usuario.
          </Typography>

          <Typography color='text.primary' fontSize={18}>
            Me apasiona construir productos intuitivos y escalables, combinando diseño, lógica de
            negocio y buenas prácticas de desarrollo para crear soluciones funcionales, mantenibles
